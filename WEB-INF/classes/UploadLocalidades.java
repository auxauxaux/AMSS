...
public class UploadLocalidades extends HttpServlet {
      ...
      while ( i.hasNext () ) 
      {
         ...
         if ( !fi.isFormField () )	
         {
			...
			while ((sCurrentLine = br.readLine()) != null) {
				String[] localidades = sCurrentLine.split(",");
				int id = Integer.parseInt(localidades[2]);
				String nombre = localidades[3];
				String idM = localidades[1];
				String query = "INSERT INTO Localidad(id_localidad, nombre, id_municipio) VALUES("+id+",'"+nombre+"','"+idM+"')";
